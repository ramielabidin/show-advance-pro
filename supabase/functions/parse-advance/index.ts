      ...
      tools: [
        {
          ...
          input_schema: {
            ...
            properties: {
              ...
              hotel_checkin: { type: "string", description: "Hotel check-in time, e.g. '3:00 PM'" },
              hotel_checkin_date: { type: "string", description: "Hotel check-in date in YYYY-MM-DD format. Only set when the source explicitly states a check-in date (e.g. 'check in Friday May 3'); leave null if only a time is given." },
              hotel_checkout: { type: "string", description: "Hotel check-out time, e.g. '11:00 AM'" },
              hotel_checkout_date: { type: "string", description: "Hotel check-out date in YYYY-MM-DD format. Only set when the source explicitly states a check-out date; leave null if only a time is given." },
