...
-- settlement, revenue-simulator, integration, team-management, outbound-share,
-- and structural-edit (create/delete show, import advance) surfaces. Kept as
-- a separate column so owner/member stays single-purpose and doesn't need
-- a three-value enum.
--
