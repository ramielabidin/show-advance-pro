...
**Total violations: 31** · **Resolved: 19** · **Open: 12**
...
1. **`src/components/BandDocuments.tsx:175`** — `confirm()` is the only remaining browser-native destructive dialog in the codebase.
