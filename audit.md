...
**Total violations: 31** · **Resolved: 11** · **Open: 20**
...
2. **`src/components/BandDocuments.tsx:175`** — `confirm()` is the only remaining browser-native destructive dialog in the codebase.
