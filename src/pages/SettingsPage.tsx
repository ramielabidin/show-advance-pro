...
export default function SettingsPage() {
  ...
  // Artists can't reach integrations / party / team. If they land on one via
  // a stale link or bookmark, bounce them to General.
  useEffect(() => {
    if (!isArtist) return;
  ...
  // Owner-only: flip a member's access role between admin and artist.
